...
NOTE: I don't have access to this collection, so use Kaelyn's username. Password is CHKbu0420\*. To check what collections I have access to, use

```         
nc_requests(username = "claire.atherton")
```

My request IDs are 242362 and 249886.
...
NOTE: Have to be very careful about syntax. If you left join by utm_square first then you'll only get squares with BCCH in it, no empty squares.

```{r Read in utm_squares}

utm_squares <- st_read("C:/Users/catherton/Documents/Shapefiles/On_Squares/On_Squares/On_Squares.shp")
